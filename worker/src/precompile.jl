...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:stdout,), Tuple{IO}}, typeof(runclient), Module, ClientInfo})
...
precompile(Tuple{typeof(send_pong), Base.PipeEndpoint, Int})
precompile(Tuple{typeof(send_sockets), Base.PipeEndpoint, String, String, Int})
# Scoped I/O
